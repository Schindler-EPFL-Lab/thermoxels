...
## {background-color="#ffffff" visibility="uncounted" transition="slide"}
...
<span style=" font-weight: bold; font-size: 60px; color:#dc0000;">Background</span>
:::
...
<li class="fragment" data-fragment-index="4">0.2% deep renovation</li>
</ul>
...
::: {.fragment}
Simplify data collection for building renovation
:::
...
![](../images/synthesized_video_rgb_facade.gif){width="300" style="height: auto;"}
:::

::: {.fragment fragment-index=2 .fade-in}
![](../images/LES-thermonerf.gif){width="300" style="height: auto;"}
:::
...
## {background-color="#fffff" visibility="uncounted" transition="slide"}
...
::: {.fragment}
First method to convert sparse set of RGB+Thermal images to a Volumetric mesh compatible with FEA
:::
<!-- 
## Thermoxels
...
::: {.incremental}
* First method to build 3D models compatible with FEA using sparse RGB images.
* Metric do not capture mesh quality.
...
<div class="fragment fade-out" data-fragment-index="1">
![](../images/simulation/1.png){.absolute top=0 left=200 width="600" style="height: auto;"}
</div>
<div class="fragment fade-in-then-out" data-fragment-index="1">
![](../images/simulation/2.png){.absolute top=0 left=200 width="600" style="height: auto;"}
</div>
<div class="fragment fade-in-then-out" data-fragment-index="2">
![](../images/simulation/3.png){.absolute top=0 left=200 width="600" style="height: auto;"}
</div>
<div class="fragment fade-in-then-out" data-fragment-index="3">
![](../images/simulation/4.png){.absolute top=0 left=200 width="600" style="height: auto;"}
</div>
<div class="fragment fade-in-then-out" data-fragment-index="4">
![](../images/simulation/5.png){.absolute top=0 left=200 width="600" style="height: auto;"}
</div>
<div class="fragment fade-in-then-out" data-fragment-index="5">
![](../images/simulation/6.png){.absolute top=0 left=200 width="600" style="height: auto;"}
</div>
<div class="fragment fade-in" data-fragment-index="6">
